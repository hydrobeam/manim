...
from manim.utils.simple_functions import clip, fdiv
...
class CameraFrame(OpenGLMobject):
    euler_angles = _Data()
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.euler_angles = np.array(euler_angles, dtype=float)
...
class Camera(CameraFrame):
    def __init__(
        ...
        **kwargs
        ...
        self.max_allowable_norms = max_allowable_norm
